<div class="max-w-xl  max-h-80 border border-solid rounded-lg border-grayBorder bg-cardFill py-5 px-3 ">
    <div dir="rtl" class="grid grid-cols-3 gap-x-6">
        <div class="flex flex-col justify-center items-center gap-2">
            <p class="text-grayText font-bold">القبس</p>

            <img :src="'/src/assets/photos/companyLogo.png'" class="w-12 cursor-pointer" />
        </div>
        <p class="mt-7 text-xl font-bold">موظف إستقبال</p>
    ...
    <div class="mt-4 flex flex-col justify-center">
        <p dir="rtl" class="text-right pr-4 pl-2 pb-5">
            حتاج أفرادا ذو خبرة ورؤية فنية في تصميم الجرافيك, والإستعداد للعمل مع فريق, يفضل أن يكون ماهرا في إستخدام
            برنامج Adobe illustrator, Adobe Photoshop, Figma...
        </p>
        <div
